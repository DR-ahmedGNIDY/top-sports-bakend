// Idempotent seed for the Top Sports Academy SUPER_ADMIN accounts.
...
const SUPER_ADMINS = [
  { name: 'Top Admin', email: 'top@admin.com', password: 'top2026#' },
  { name: 'Ahmed Admin', email: 'ahmed@admin.com', password: '20124194114' },
];
